...
#Region "Char Creation"
    ...
    Private Sub LblPrevChar_Click(sender As Object, e As EventArgs) Handles lblPrevChar.Click
        NewCharSprite = NewCharSprite - 1
        If rdoMale.Checked = True Then
            If NewCharSprite < 0 Then NewCharSprite = Classes(NewCharClass).MaleSprite.Length - 2
        ElseIf rdoFemale.Checked = True Then
            If NewCharSprite < 0 Then NewCharSprite = Classes(NewCharClass).FemaleSprite.Length - 2
        End If
        DrawCharacter()
    End Sub
